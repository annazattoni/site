...
**Semplicità**, **originalità**, **qualità**, **strategia**: questi quattro sostantivi, secondo me, descrivono i contenuti capaci di distinguersi.
...
Affinché la navigazione su un sito non si tramuti in un'esperienza mistica, serve avere **contenuti leggibili**, di **facile comprensione** e inseriti in una specifica **strategia**. Lo stesso vale per i post sui canali social e per i testi destinati alle campagne adv, obbligatoriamente coerenti con quelli del sito di riferimento.
...
Redigere testi per un sito, per un canale social, per una newsletter o per una campagna adv non è la stessa cosa. Ciascuna di queste attività ha le proprie esigenze.
In linea di massima, però, posso dire di attenermi a questo modus operandi:
...
L'importante è che non siano parole qualsiasi, ma quelle capaci di comunicare al meglio la tua realtà o il tuo progetto!
...
In termini di visibilità, di autorevolezza e d'interazione B2B o B2C, i comunicati possono avere un buon ritorno sull'azienda o sul progetto.
L'importante è redigerli secondo una strategia.

Quando mi dedico a un comunicato stampa:
...
_O capito che ai voglia di publicare il tuo libro, ma non è che puoi farlo così, senza riguardare lui a dovere. Ti pare?_
...
In termini di **reputazione**, di **consapevolezza del marchio** e di **generazione di contatti/potenziali clienti**, penso che un eBook sia un ottimo strumento.
...
Alta leggibilità, testi chiari, link di approfondimento, dati significativi, belle immagini, video e contenuti audio sono fra i _must have_.
